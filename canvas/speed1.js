...
Loader.prototype.start = function(remove) {
    if (typeof remove !== "undefined") {
        document.getElementById('speed').parentNode.removeChild(document.getElementById('speed'));
    }
    var canvas = document.createElement('speed');
    canvas.setAttribute('height', 300);
    canvas.setAttribute('width', 300);
    canvas.setAttribute('id', 'speed');
    this.options.loader.appendChild(canvas);
    this.canvas = new Canvas(document.getElementById('speed'));
    this.canvas.render();
    this.percentage = 0;
};
